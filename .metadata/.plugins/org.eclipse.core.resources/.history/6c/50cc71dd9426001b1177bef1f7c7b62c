...
void i2c_ev_irq_handler(i2c_handle_t *arg_poi2c_handler) {
	...
	uint8_t loc_u8is_irq_expected = ((arg_poi2c_handler->m_poi2c_reg->CR2 >> I2C_CR2_ITEVTEN)
			& SET);
	/*!< Handle SB IRQ >*/
...
void i2c_er_irq_handler(i2c_handle_t *arg_poi2c_handler) {
	...
	uint8_t loc_u8is_irq_happened = (FLAG_SET
			== i2c_get_flag_status(arg_poi2c_handler->m_poi2c_reg,
			I2C_FLAG_BERR));
	uint8_t loc_u8is_irq_expected = ((arg_poi2c_handler->m_poi2c_reg->CR2 >> I2C_CR2_ITERREN)
			& SET );
	if (loc_u8is_irq_expected && loc_u8is_irq_happened) {
...
void i2c_init(i2c_handle_t *arg_ptr_oi2c_handler) {
	...
	arg_ptr_oi2c_handler->m_poi2c_reg->OAR1 |=
			((arg_ptr_oi2c_handler->m_poi2c_sconfig->device_addr & SEVEN_BIT) << I2C_OAR1_ADD71);
...
__attribute__((weak)) void i2c_app_callback(i2c_handle_t *arg_poi2c_handler, uint8_t arg_u8evt) {

...
void EXTI0_IRQHandler(void) {
	...
	i2c_master_send_data(&gl_oi2c1_handle, &loc_u8commande_code, 1, SLAVE_ADDR, I2C_REPEAT_START_YES);

	i2c_master_receive_data(&gl_oi2c1_handle, &loc_u8len, 1, SLAVE_ADDR, I2C_REPEAT_START_YES);

	loc_u8commande_code = 0x52;
	i2c_master_send_data(&gl_oi2c1_handle, &loc_u8commande_code, 1, SLAVE_ADDR, I2C_REPEAT_START_YES);


	i2c_master_receive_data(&gl_oi2c1_handle, loc_au8buffer, loc_u8len, SLAVE_ADDR, I2C_REPEAT_START_NO);
